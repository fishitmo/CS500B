...
def main():
    ...
    student1 = Student(1,"Daniel",123.89)
    student2 = Student(2,"Felix",133.89)
    student3 = Student(3,"Biniam",133.89)
    ...
    # testing classroom 
    classroom = Classroom("101 Lab",456.23,23,ClassroomType.COMPUTER_LAB)
    clasrom2 = Classroom("101 Lab",456.23,23,ClassroomType.SEMINAR_ROOM)
