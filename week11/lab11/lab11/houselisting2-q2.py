    ...
    def notify(self, event: str, house: House) -> None:
        ...
        for observer in self.__observers:
            if event == "House added to listing":
                ...
                # notify all agents and owner and porspective buyers
...
def main():
    ...
    house4 = House('4444 Mission Blvd', 4000, 5, 3000000, 'Hayward')
    ...
    print()
    print("========== Adding a house4 to the listing ==========")
    agent1.add_house_to_listing_for_owner(owner1, house4)
    agent1.help_buyer_to_save_to_watchlist(buyer1, house4)
